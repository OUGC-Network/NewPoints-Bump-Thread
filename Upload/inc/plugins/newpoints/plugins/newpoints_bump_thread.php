...
function newpoints_bump_thread_info()
{
    ...
    if (!$mybb->get_input('module') || $mybb->get_input('module') == 'newpoints' || $mybb->get_input(
            'module'
        ) == 'newpoints-plugins') {
...
function newpoints_bump_thread_install()
{
    ...
    $db->field_exists('lastpostbump', 'threads') or $db->add_column(
        'threads',
        'lastpostbump',
    ...
    $db->field_exists('bumps_rate', 'newpoints_forumrules') or $db->add_column(
        'newpoints_forumrules',
        'bumps_rate',
        'float NOT NULL default \'1\''
    );
    $db->field_exists('bumps_forums', 'newpoints_grouprules') or $db->add_column(
        'newpoints_grouprules',
        'bumps_forums',
        'text NOT NULL'
    );
    $db->field_exists('bumps_groups', 'newpoints_forumrules') or $db->add_column(
        'newpoints_forumrules',
        'bumps_groups',
        'text NOT NULL'
    );
    $db->field_exists('bumps_interval', 'newpoints_grouprules') or $db->add_column(
        'newpoints_grouprules',
        'bumps_interval',
        'int(10) NOT NULL DEFAULT \'0\''
    );
    $db->field_exists('bumps_interval', 'newpoints_forumrules') or $db->add_column(
        'newpoints_forumrules',
        'bumps_interval',
        'int(10) NOT NULL DEFAULT \'0\''
    );
    $db->field_exists('lastpostbump', 'users') or $db->add_column(
        'users',
        'lastpostbump',
        'int(10) NOT NULL DEFAULT \'0\''
    );
...
function newpoints_bump_thread_uninstall()
{
    ...
    !$db->field_exists('bumps_forums', 'newpoints_grouprules') or $db->drop_column(
        'newpoints_grouprules',
        'bumps_forums'
    );
    !$db->field_exists('bumps_groups', 'newpoints_forumrules') or $db->drop_column(
        'newpoints_forumrules',
        'bumps_groups'
    );
    !$db->field_exists('bumps_interval', 'newpoints_grouprules') or $db->drop_column(
        'newpoints_grouprules',
        'bumps_interval'
    );
    !$db->field_exists('bumps_interval', 'newpoints_forumrules') or $db->drop_column(
        'newpoints_forumrules',
        'bumps_interval'
    );
